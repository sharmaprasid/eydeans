  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="mb-4">
      ...
      <select
        ...
        name="gender"
        value={
          localStorage.gender ? localStorage.getItem("gender") : formData.gender
        }
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="mb-4">
      ...
      <input
        ...
        name="wardNo"
        value={
          localStorage.wardNo ? localStorage.getItem("wardNo") : formData.wardNo
        }
  ...
  <div className="mb-4">
    <label className="flex items-center text-gray-700 text-sm">
      <input
        ...
        required
      />
      I declare that all the information provided above is genuine and correct
